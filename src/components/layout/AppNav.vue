...
<template>
  ...
  <nav
    class="md:hidden fixed bottom-0 left-0 right-0 z-[200] flex bg-white border-t border-[#e8e2dc]"
  ...
  <nav
    class="hidden md:flex fixed top-0 left-0 bottom-0 w-[200px] flex-col gap-1 pt-20 px-3 pb-6 bg-white border-r border-[#e8e2dc] z-[300]"

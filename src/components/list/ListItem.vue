...
<template>
  ...
  <div
    v-else
    class="flex flex-col theme-surface rounded-2xl shadow-[0_2px_16px_rgba(0,0,0,0.06)] overflow-hidden animate-fadeUp"
  >
    <div
      class="flex items-center relative p-4 cursor-pointer transition-all hover:shadow-[0_8px_32px_rgba(0,0,0,0.10)] active:shadow-[0_1px_4px_rgba(0,0,0,0.15)] active:scale-[0.98]"
      @click="onSpeak"
    >
    ...
    <ListQuizQueueBar :cat="cat" :id="item.id" slim class="px-4 pb-3" @click.stop />
  </div>
</template>

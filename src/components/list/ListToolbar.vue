  ...
  <div class="flex flex-col gap-2 px-4 pb-3">
    <div class="relative">
      <input
        ...
        class="w-full pl-10 pr-4 py-2.5 rounded-[10px] border border-[#e8e2dc] bg-white text-[#2d2d2d] text-sm outline-none focus:border-[#e8735a] transition-colors"
        @input="onSearch"
      />
      <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#777]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
